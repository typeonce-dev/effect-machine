...
for (const [declarationText, fixture] of [
  ["export const can:", "can"],
  ["export interface Machine<", "guard"]
]) test(`Machine documents the compile-checked ${fixture} example`, () => {
  ...
  const expected = readFileSync(new URL(`../../packages/effect-machine/test/examples/${fixture}.ts`, import.meta.url), "utf8")
